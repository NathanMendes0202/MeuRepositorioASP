<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Popular2.aspx.cs" Inherits="CaldeiraoFurado.WebForm5" %>
...
<body>
    ...
    <div class="container">
        <div class="row mt-5">
            <div class="col-md-6">
                <h1 id="harry">Suite Familia</h1>
                <p style="font-family: 'Times New Roman', Times, serif;">Suíte família é o quarto ideal para acomodar a sua família.</p>
            ...
            <div class="col-md-6">
                ...
                <h2 style="margin-left: 410px;">R$ 1.250</h2>
                <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#modal2" style="margin-left: 75%; width: 130px;"> Datas</button>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-8">
                <img src="img/Familia_g.jpg" style="border-radius: 1% 1% 1% 1%;"><br>
            </div>
            ...
            <div class="col-md-4">
                ...
                <div style="height: 40px; width: 70px; background-color: green;">
                    <center>
                        <label style="font-size: 30px; color: white;">8,4</label>
                    </center>
                </div>
