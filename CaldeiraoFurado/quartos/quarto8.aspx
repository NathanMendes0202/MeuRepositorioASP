    ...
    <div class="container">
        <div class="row mt-5">
            ...
            <div class="col-md-6">
                ...
                <h2 style="margin-left: 410px;">R$ 500</h2>
        ...
        <div class="row">
            <div class="col-md-8">
                <img src="../img/quartos/quarto8.jpg" style="border-radius: 1% 1% 1% 1%; margin-top: 35px;">
            </div>
            ...
            <div class="col-md-4">
                ...
                <div style="height: 40px; width: 70px; background-color: green;">
                    <center>
                        <label style="font-size: 30px; color: white;">5,0</label>
                    </center>
                </div>

                <label class="mt-2"><b>Expecional</b></label>
                <label>07 avaliações de hóspedes <u style="color: blue;">verificadas</u></label>
