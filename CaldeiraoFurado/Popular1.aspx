<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Popular1.aspx.cs" Inherits="CaldeiraoFurado.WebForm4" %>
...
<body>
    ...
    <div class="container">
        <div class="row mt-5">
            <div class="col-md-6">
                <h1 id="harry">Suite da Luz</h1>
                <p style="font-family: 'Times New Roman', Times, serif;">A suíte da Luz conta com uma bela decoração e o
                    melhor enxoval para quem busca conforto e o espaço
                    ideal.</p>
        ...
        <div class="row">
            <div class="col-md-8">
                <img src="img/Luz.jpg" style="border-radius: 1% 1% 1% 1%;"><br>
            </div>
            ...
            <div class="col-md-4">
                ...
                <div style="height: 40px; width: 70px; background-color: green;">
                    <center>
                        <label style="font-size: 30px; color: white;">9,4</label>
                    </center>
                </div>
